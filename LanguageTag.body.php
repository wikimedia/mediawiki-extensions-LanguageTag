 ...
 * this extension is used together with the LanguageSelector extension, ideally $wgLanguageTagLanguages is identical with $wgLanguageSelectorLanguages
...
class LanguageTag {
	...
	public static function LanguageTagParserInit( Parser $parser ) {
		...
		if ( $wgLanguageTagLanguages === [] ) { return true; // Nothing to do
		}
	...
	public static function __callStatic( $name, $arguments ) {
	   return $arguments[2]->recursiveTagParse( self::LanguageTagCheck( $arguments[0], substr( $name, 18 ) ), $arguments[3] );
	}
}
